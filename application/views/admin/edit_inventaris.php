...
<div id="maincontent" class="ui main container">
    <h1 class="ui header">Edit Inventaris</h1>
    <div class="ui stackable grid">
        <div class="nine wide column">
            <div id="regInnkommende" class="ui stacked segment">
                <a class="ui ribbon orange label">Edit Barang</a>
                <div class="ui cards">
                    <form class="ui form" method="post" action="<?= base_url('admin/simpan_inventaris/'); ?>">
                        <div class=" field">
                            <br>
                            <div class="three fields">
                                <div class="field">
                                    <label>Id</label>
                                    <input type="text" name="id_barang" placeholder="Id" value="<?= $edit['id_barang'] ?>" readonly="readonly">
                                </div>
                                <div class="field">
